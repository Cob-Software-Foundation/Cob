...
if [ "$RAW_ARCH" = "x86_64" ]; then
    ...
    DOWNLOAD_URL="https://github.com/Cob-Software-Foundation/Cob/releases/latest/download/cob-linux-amd64.zip"
    ...
    DOWNLOAD_URL="https://github.com/Cob-Software-Foundation/Cob/releases/latest/download/cob-linux-arm64.zip"
    ...
    DOWNLOAD_URL="https://github.com/Cob-Software-Foundation/Cob/releases/latest/download/cob-linux-arm32.zip"
    ...
    DOWNLOAD_URL="https://github.com/Cob-Software-Foundation/Cob/releases/latest/download/cob-linux-386.zip"
else
