...
TCL_DEFS='-DPACKAGE_NAME=\"tcl\" -DPACKAGE_TARNAME=\"tcl\" -DPACKAGE_VERSION=\"9.0\" -DPACKAGE_STRING=\"tcl\ 9.0\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE_URL=\"\" -DTCL_CFGVAL_ENCODING=\"utf-8\" -DSTATIC_BUILD=1 -DMODULE_SCOPE=extern -DTCL_CFG_DO64BIT=1 -DHAVE_NO_SEH=1 -DHAVE_CAST_TO_UNION=1 -DTCL_WITH_INTERNAL_ZLIB=1 -DHAVE_INTPTR_T=1 -DHAVE_UINTPTR_T=1 -DZIPFS_BUILD=2 -DHAVE_INTRIN_H=1 -DHAVE_CPUID_H=1 -DHAVE_WSPIAPI_H=1 -DNDEBUG=1 -DTCL_CFG_OPTIMIZED=1'
...
# build directory.
TCL_BUILD_LIB_SPEC='-LC:/Users/Mo/Pictures/Cob-v0.0.5/vendor/TCL/win libtcl90.a'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/usr/local/lib libtcl90.a'
...
# compiled.
TCL_SRC_DIR='C:/Users/Mo/Pictures/Cob-v0.0.5/vendor/TCL'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-LC:/Users/Mo/Pictures/Cob-v0.0.5/vendor/TCL/win -ltclstub'
...
TCL_BUILD_STUB_LIB_PATH='C:/Users/Mo/Pictures/Cob-v0.0.5/vendor/TCL/win/libtclstub.a'
